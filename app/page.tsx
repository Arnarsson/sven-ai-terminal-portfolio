...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-terminal-dark-bg">
      {/* Hero Section with Terminal */}
      <section className="relative">
        {/* Background Effects */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-10 left-10 w-72 h-72 bg-terminal-green/5 rounded-full blur-3xl" />
          <div className="absolute bottom-10 right-10 w-96 h-96 bg-terminal-green/3 rounded-full blur-3xl" />
        </div>
      ...
      <section className="py-16 bg-terminal-terminal-bg/50">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-terminal-green mb-4">
              AI Consulting Excellence
            </h2>
            <p className="text-terminal-secondary-text text-lg max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* ROI Calculator Demo */}
            <div className="bg-terminal-hover border border-terminal-border rounded-lg p-6 hover:border-terminal-green transition-all duration-300 hover:shadow-glow">
              <div className="text-terminal-green text-2xl mb-4">📊</div>
              <h3 className="text-xl font-bold text-terminal-text mb-3">Live ROI Calculator</h3>
              <p className="text-terminal-secondary-text mb-4">
            ...
            <div className="bg-terminal-hover border border-terminal-border rounded-lg p-6 hover:border-terminal-green transition-all duration-300 hover:shadow-glow">
              <div className="text-terminal-green text-2xl mb-4">🎯</div>
              <h3 className="text-xl font-bold text-terminal-text mb-3">Market Intelligence</h3>
              <p className="text-terminal-secondary-text mb-4">
            ...
            <div className="bg-terminal-hover border border-terminal-border rounded-lg p-6 hover:border-terminal-green transition-all duration-300 hover:shadow-glow">
              <div className="text-terminal-green text-2xl mb-4">⚡</div>
              <h3 className="text-xl font-bold text-terminal-text mb-3">Automation Assessment</h3>
              <p className="text-terminal-secondary-text mb-4">
            ...
            <div className="bg-terminal-hover border border-terminal-border rounded-lg p-6 hover:border-terminal-green transition-all duration-300 hover:shadow-glow">
              <div className="text-terminal-green text-2xl mb-4">📈</div>
              <h3 className="text-xl font-bold text-terminal-text mb-3">Real-Time Analytics</h3>
              <p className="text-terminal-secondary-text mb-4">
            ...
            <div className="bg-terminal-hover border border-terminal-border rounded-lg p-6 hover:border-terminal-green transition-all duration-300 hover:shadow-glow">
              <div className="text-terminal-green text-2xl mb-4">🤖</div>
              <h3 className="text-xl font-bold text-terminal-text mb-3">AI Workflow Demo</h3>
              <p className="text-terminal-secondary-text mb-4">
            ...
            <div className="bg-terminal-hover border border-terminal-border rounded-lg p-6 hover:border-terminal-green transition-all duration-300 hover:shadow-glow">
              <div className="text-terminal-green text-2xl mb-4">🏢</div>
              <h3 className="text-xl font-bold text-terminal-text mb-3">Business Intelligence</h3>
              <p className="text-terminal-secondary-text mb-4">
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <p className="text-terminal-secondary-text text-lg mb-8 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              ...
              className="bg-terminal-green text-terminal-terminal-bg px-8 py-4 rounded-lg font-bold text-lg hover:bg-terminal-green/90 transition-all duration-300 hover:shadow-glow inline-block"
            >
              Book Free Assessment
            </a>
            <div className="text-terminal-secondary-text">
              or type <span className="text-terminal-green font-mono">contact</span> in terminal
            </div>
          </div>
          
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
            <div className="text-terminal-secondary-text">
              <div className="text-terminal-green font-bold text-2xl">48h</div>
              <div className="text-sm">Delivery Guarantee</div>
            </div>
            <div className="text-terminal-secondary-text">
              <div className="text-terminal-green font-bold text-2xl">300%+</div>
              <div className="text-sm">Typical ROI</div>
            </div>
            <div className="text-terminal-secondary-text">
              <div className="text-terminal-green font-bold text-2xl">100%</div>
      ...
      {/* SEO Footer */}
      <footer className="bg-terminal-terminal-bg border-t border-terminal-border py-8">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <div className="text-terminal-secondary-text text-sm">
            <p className="mb-2">
